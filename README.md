...
This was built with [version 1.6.3](https://dl.bintray.com/mitchellh/vagrant/Vagrant-1.6.3.dmg).
...
- [rbenv](https://github.com/sstephenson/rbenv) with ruby v2.0.0-p481 installed
